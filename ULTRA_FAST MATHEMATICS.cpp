...
Each of them contains a single number.
...
Similarly, for third position the value at third position of str1 is 1 and str2 is 0,so , there will be 1 at the third position of the final ans and So, on.
*/
#include<iostream>
#include<bits/stdc++.h>
using namespace std;
